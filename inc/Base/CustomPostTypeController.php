...
use MiltonPlugin\Inc\Api\Callbacks\CptCallbacks;
...
class CustomPostTypeController extends BaseController {
    ...
    public function register() {
        ...
        if ( !$this->activated( 'cpt_manager' ) ) { //jodi activate na hoi ,not true hole return hobe
            return;
        }
    ...
    public function setSettings() {
        ...
        $args = array(
            array(
                ...
                'option_name'  => 'milton_plugin_cpt', //page name
    ...
    public function setFields() {
        ...
        $args = array(
            array(
                ...
                'page'     => 'milton_cpt',
                'section'  => 'milton_cpt_index',
                'args'     => array(
                    'option_name' => 'milton_plugin_cpt',
                    'label_for'   => 'post_type',
